...
//          CHANGE THE FOLLOWING INFORMATION TO SEND EMAIL FOR YOU //  
	...
	$toEmail = "vlkelly92@yahoo.com";		//will send the email to the email address entered on the form 
	...
	$fromEmail = "vlkelly92@yahoo.com";		//Change the email address within the quotes to be YOUR host server email address.  
